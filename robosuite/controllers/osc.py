...
class OperationalSpaceController(Controller):
    ...
    def run_controller(self):
        ...
        """
        # Update state
        self.update() #ANDYNOTE: redundant during policy step, but that's probably relatively rare.
        ...
        self.torques = np.dot(self.J_full.T, decoupled_wrench) + self.torque_compensation - self.constraint_compensation
